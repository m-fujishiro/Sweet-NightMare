...
:doze
echo 甘い夢に溺れる。揺蕩う意識の中、悪魔の声が聞こえた気がした。
:doze2
...
echo 私に出来ることは、ただ考えるだけ。
set /a san+=1 & set /a addict-=1 & set /a dist+=1 & set stay_count=0
exit /b 0

:awake
set esc=false
echo "――どこへ行くんだい？"
set /a san-=10+addict & set /a addict-=10 & set /a dist+=5
if %san% gtr 0 (
 choice /m 逃げますか？ 
 echo.
) else (
